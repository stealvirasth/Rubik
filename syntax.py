...
owner=["u0dc04038d28145eba9676c94f130684f","u03568a9ce9749af020bcd6a303ee22f5","ucf8a8e31a6f102cd80730417158f5dce"]
admin=["u0dc04038d28145eba9676c94f130684f","u03568a9ce9749af020bcd6a303ee22f5","ucf8a8e31a6f102cd80730417158f5dce"]
...
#--------------------------------------------------------
            ...
            elif ".syn tolong " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace(".syn tolong ","")
                    if gid == "":
...
#===============================================
        ...
        if op.type == 15:
            if wait["Lv"] == True:
                if op.param2 in Bots:
                    return
                kr1.sendText(op.param1, "╔═════════════\n║ :v dia tlah pergi tinggalkan ku \n║Sehat selalu ya kk 😊 \n╚═════════════")
