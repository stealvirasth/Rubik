...
kr1 = QHAL.LINE()
kr1.login(token="EqOqo3GSAyNOHSZbsNw0.jS8fXQuRSGdr0BhIcOpl4a.ohYKyUuZujOwCIUSKEyNBe+jyI1+oCjJuu/5p6mL5l0=")
kr1.loginResult()

kr2 = QHAL.LINE()
kr2.login(token="EqgqAZIOhBp02uTiwrz9.vmxpkT3J6+aNORjFa1pEcq.IixRKrvzPsBENH/wkx3dCU1wfLCp5upCVPGUmLO7jrI=")
kr2.loginResult()

kr3 = QHAL.LINE()
kr3.login(token="EqWrYFmH4gQjopy5bn0c.ZB3ru0i4RZ3bM29ZRmye7a.6JlqE3yUj0oaOtj15gaA5dA+JDN9vGzeY7LmMN0JQCM=")
kr3.loginResult()

kr4 = QHAL.LINE()
kr4.login(token="Eq29GKI64vOBE1I9Fya2.7p6LQCFBC7mcnB51ZVEq4G.PiO2Wz/KiiI1Yj/v+8wPn5z2xIpCa8pgu42Uv4hOAPc=")
kr4.loginResult()

kr5 = QHAL.LINE()
#kr5.login(qr=True)
kr5.login(token="EqJfVnfPbIOuNmI3aD23.wIUCphX9zE2xb080w3/jmW.HLP3hLb9fULcl6yMr+7hQzKdkiJ0nOxsdd9IuAwOn3w=")#5
kr5.loginResult()

kr6 = QHAL.LINE()
kr6.login(token="EqDp9jNmnB9kmZFrebo4.pk3CzUIw9DBJ/vzT8aNr1a.xBeqMkHGdloHlZQqzbzKcMfTtREcLi3G4Z3Hb0Q3hrs=")
kr6.loginResult()

kr7 = QHAL.LINE()
kr7.login(token="Eq2ie9sSjhO5RBhLP3ae.mwTJbxkoAEL5V+GLhgfEJG.4zOsmS5MseOIBfUEB08LJ3W/cf611nAR4FXFh+lA56k=")
kr7.loginResult()

kr8 = QHAL.LINE()
kr8.login(token="EqHQLBSaDMAP6EOgGCpb.OSs/UE2u1V/Nvnvobdxc6W.bQH4uTfDn6ZfNTMU5KbBS2rQbF6c9VLjmHIcyWA2Ohw=")
kr8.loginResult()

kr9 = QHAL.LINE()
kr9.login(token="EqJpF6wutrZNVQmWBot7.xYVcvszuOpJQQn+3L70zXW.A1v3YUbwsjowQmVZ/WtrbjF5osh2BlqPQ0RSlIvbyys=")
kr9.loginResult()

kr10 = QHAL.LINE()
kr10.login(token="EqmKHYjdYWz5iWXiSgl3.fcFxs8qZyt3PY185VbldmW.CiiSfJAPqlDY7wUdGfuboUuUBb4LPsIJe157Rzu0nC8=")
kr10.loginResult()

kr11 = QHAL.LINE()
kr11.login(token="Equ5OPZ1PHK1YUJhAnu7.kCxvJN00Lczen/Zn+vp0nW.APzWLNkJ4TZqCA3tSB+p+JyP8ICUDcLWztWVLRAIF00=")
kr11.loginResult()
...
╠═════════════        
            """  
KAC=[kr1,kr2,kr3,kr4,kr5,kr6,kr7,kr8,kr9,kr10,kr11]
...
Bots=[mid,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11]
owner=["u0dc04038d28145eba9676c94f130684f"]
admin=["u0dc04038d28145eba9676c94f130684f"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"""Thx for add☆ Created By : http://line.me/ti/p/aSeP3kWx9Yº°˚˚✰""",
    "lang":"JP",
    "comment":"Auto Like by: Rianđo Syn",
    "commentOn":False,
    "commentBlack":{},
    "wblack":True,
    "dblack":True,
                ...
                if msg.from_ in admin:
                    ...
                    if wait["cancelprotect"] == True:
                        if wait["lang"] == "JP":
                            ...
                            kr1.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи αℓяєα∂у ��и")
                    else:
                        wait["cancelprotect"] = True
                        if wait["lang"] == "JP":
                            kr1.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи ѕєт тσ ��и")
                        else:
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentMetadata = {'mid': "u0dc04038d28145eba9676c94f130684f"}
                kr1.sendMessage(msg)
                kr1.sendText(msg.to,'❂➣ This My Creator..!')
              ...
              if msg.from_ in admin:
                if wait['sticker'] == True:
                    kr1.sendText(msg.to, "Sticker id detect already ON.")
                else:
                    wait['sticker']=True
                    kr1.sendText(msg.to, "Sticker id detect turned ON.")
            elif msg.text.lower() in ['.sticker:off','detectsticker:off','sticker off']:
              if msg.from_ in admin:
                if wait['sticker'] == False:
                    kr1.sendText(msg.to, "Sticker id detect already OFF.")
                else:
                    wait['sticker']=False
                    kr1.sendText(msg.to, "Sticker id detect turned OFF.")
#========================== FOR COMMAND BOT FINISHED =============================#
            elif msg.text in ["Cyduk on","cyduk on"]:
                if msg.from_ in admin:
                    try:
            ...
            elif msg.text in ["Cyduk off","cyduk off"]:
                if msg.from_ in admin:
...
#==========================[SyN]===========================
            elif msg.text in ["Dor on","Dor on"]:
                if msg.from_ in admin:
                    try:
            ...
            elif msg.text in ["Dor off","Dor off"]:
                if msg.from_ in admin:
...
#==========================[SyN]===========================
            ...
            #SIRI_COMMAND---------------------------
            elif msg.text in ["Shelp","Skey"]:
                print "\nHelp siri command..."
                kr1.sendText(msg.to, helpMessage2 + "")
            elif msg.text in ["S on"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:オン")
            elif msg.text in ["S off"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:オフ")

            elif msg.text in ["Owner"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:グル作成者")

            elif msg.text in ["Extra"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:予備作成者")

            elif msg.text in ["Reinvite"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:再招待")
            elif msg.text in ["Sbackup"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:バックアップ")

            elif msg.text in ["Own on"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:作成者ロック:オン")
            elif msg.text in ["Own off"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:作成者ロック:オフ")

            elif msg.text in ["Gname on"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:グループ名ロック:オン")
            elif msg.text in ["Gname off"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:グループ名ロック:オフ")

            elif msg.text in ["Icon on"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:アイコンロック:オン")
            elif msg.text in ["Icon off"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:アイコンロック:オフ")

            elif msg.text in ["Spam on"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:スタンプ規制:オン")
            elif msg.text in ["Spam off"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:スタンプ規制:オフ")

            elif msg.text in ["Qr on"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:招待URL拒否")
            elif msg.text in ["Qr off"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "Siri:招待URL生成")

            elif msg.text in ["Blockinvite on"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:招待拒否:オン")
            elif msg.text in ["Blockinvite off"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:招待拒否:オフ")

            elif msg.text in ["Turn"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:作者交換")

            elif msg.text in ["Cown"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:グル作者変更")

            elif msg.text in ["Cextra"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:予備作者変更")
            elif msg.text in ["Dextra"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:予備作者削除")

            elif msg.text in ["Sbl"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:ブラック追加")
            elif msg.text in ["Swl"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:ホワイト追加")
            elif msg.text in ["Scek"]:
                print "\nSIRI_COMMAND"
                kr1.sendText(msg.to, "設定:確認")
#-------------SIRI--------------------
...
#==============================================================================#
              ...
              if admin == []:
                ...
                if msg.from_ in owner:
                    ...
                    G.preventJoinByTicket = True
                    kr1.updateGroup(G)
                    kr5.sendText(msg.to,"Hallo Guys,...! " + str(ginfo.name) + "\n\nSalken semuanyah,...")
...
#==============================================================================#
                ...
                if msg.from_ in owner:
                    ...
                    if len(string.decode('utf-8')) <= 10000000000:
                        profile = kr11.getProfile()
                        profile.displayName = string
                        kr11.updateProfile(profile)
                        kr11.sendText(msg.to,"Changed " + string + "")
...
#==============================================================================#
                ...
                if msg.from_ in admin:
                    ...
                    kr10.sendText(msg.to,"▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄")
                    kr1.sendText(msg.to,"ALL BOT IS ACTIVE..!!!")
...
#==============================================================================#
            ...
            elif msg.text in [".pop",".pip"]:
                if msg.from_ in admin:
                    url = "http://dl.profile.line-cdn.net/0hNb5IWhUPEU0IMD2gjDJuGjR1HyB_HhcFcFZbKCtlSXh2UlMZNlFeKXhkRy92BAEZPAUMKy5iTX8n"
                    url1 = "http://dl.profile.line-cdn.net/0hNb5IWhUPEU0IMD2gjDJuGjR1HyB_HhcFcFZbKCtlSXh2UlMZNlFeKXhkRy92BAEZPAUMKy5iTX8n"
                    url6 = "http://dl.profile.line-cdn.net/0hznNTmFajJUFzLQmsgFpaFk9oKywEAyMJC09vdVJ_LHIOSDdDTR85cFcufSFdTmETGEpoI1R4L3BW"
                    url7 = "http://dl.profile.line-cdn.net/0hznNTmFajJUFzLQmsgFpaFk9oKywEAyMJC09vdVJ_LHIOSDdDTR85cFcufSFdTmETGEpoI1R4L3BW"
                    kr1.sendImageWithURL(msg.to, url)
                    kr1.sendImageWithURL(msg.to, url1)
                    kr1.sendImageWithURL(msg.to, url6)
                    kr1.sendImageWithURL(msg.to, url7)
...
#--------------------------------------------------------
                ...
                if msg.from_ in owner:
                    ...
                    kr1.sendMessage(msg)
            elif msg.text in [".syn",".bot"]:
                if msg.from_ in owner:
                    kr1.sendText(msg.to,"Yes Sir...!")
#===============================================
        if op.type == 17:
            if op.param2 not in Bots:
...
#------------------------------------------------------------------------------#
        ...
        if op.type == 55:
            try:
                if wait2['cyduk'][op.param1]==True:
                        if op.param1 in wait2['point']:
                            Name = kr1.getContact(op.param2).displayName
                            Np = kr1.getContact(op.param2).pictureStatus
                            if Name in wait2['sidermem'][op.param1]:
                                pass
                            else:
                                wait2['sidermem'][op.param1] += "\n• " + Name
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
